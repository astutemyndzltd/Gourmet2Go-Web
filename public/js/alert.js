; (function (process) {
  require.m = {
    ...
    }, { "./": 1 }], 1: [function (require, module, exports) {
    ...
    }, { "./content": 2, "play-audio": 3 }], 2: [function (require, module, exports) {
      module.exports = {
    ...
    }, { "./src": 5, "./render": 7, "new-chain": 10 }], 5: [function (require, module, exports) {
    ...
    }, { "./mime": 6 }], 7: [function (require, module, exports) {
    ...
    }, { "./templates": 8, "domify": 9 }], 8: [function (require, module, exports) { exports["audio.html"] = "<audio preload=\"auto\" /></audio>" }, {}], 6: [function (require, module, exports) {
      var table = {
        aif: "audio/x-aiff",
        aiff: "audio/x-aiff",
        wav: "audio/x-wav",
  ...
  }; function require(o) { if (o[2]) return o[2].exports; o[0](function (u) { if (!require.m[o[1][u]]) { throw new Error('Cannot find module "' + u + '"'); } return require(require.m[o[1][u]]); }, o[2] = { exports: {} }, o[2].exports); return o[2].exports; }; return require(require.m[0]);
}({ env: {} }));